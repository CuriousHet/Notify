...
type PostServiceClient interface {
	PublishPost(ctx context.Context, in *Post, opts ...grpc.CallOption) (*NotificationResponse, error)
}
...
func (c *postServiceClient) PublishPost(ctx context.Context, in *Post, opts ...grpc.CallOption) (*NotificationResponse, error) {
...
type PostServiceServer interface {
	PublishPost(context.Context, *Post) (*NotificationResponse, error)
...
func (UnimplementedPostServiceServer) PublishPost(context.Context, *Post) (*NotificationResponse, error) {
...
func _PostService_PublishPost_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(PostServiceServer).PublishPost(ctx, req.(*Post))
	}
